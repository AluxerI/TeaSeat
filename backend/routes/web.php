...
Route::group(['namespace' => 'App\Http\Controllers\Item'], function() {
    Route::get('/item/{productId}', 'ShowController')->name('item.show.web');
    Route::get('/catalog', 'IndexController')->name('item.index.web');
    Route::get('/cities', 'LocationController@getCities');
    Route::get('/categories', 'Category\IndexController')->name('category.index.web');
